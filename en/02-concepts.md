...
When evaluating databases that live on more than one server, it is vital to understand that they are distributed systems replete with the benefits and handicaps that arise. Engineers at Sun Microsystems created this list of [eight fallacies](http://www.rgoarchitects.com/Files/fallacies.pdf) that engineers new to distributed systems often fall victim to. They still apply today, even when operating a database like Riak.
